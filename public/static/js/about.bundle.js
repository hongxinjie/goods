...
(0, _util.MP)('GZYG8lVxAa3kQElsZaGf3RlB').then(function (BMap) {
    var map = new BMap.Map("map");
    var point = new BMap.Point(120.011568,30.297893);
    ...
    var infoWindow = new BMap.InfoWindow("公司地址：杭州市余杭区梦想小镇互联网村13幢2楼", opts); // 创建信息窗口对象

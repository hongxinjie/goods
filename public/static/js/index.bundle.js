...
exports.Toast = Toast;
function Toast(msg) {
    $('body').append('<div class="message-mask toast-mask">\n            <div class="toast">\n                <i class="iconfont"></i>\n                <span>' + msg + '</span>\n            </div>\n        </div>');
    $('.toast').addClass('toastAnimate');
    setTimeout(function () {
        $('.toast-mask').remove();
    }, 3000);
}

var Indicate = exports.Indicate = {
    open: function open(callback) {
        $('body').append('<div class="message-mask indicate-mask">\n            <div class="indicate">\n                <div class="loading">\n                    <div class="inner ball_spin_fade">\n                        <div></div>\n                        <div></div>\n                        <div></div>\n                        <div></div>\n                        <div></div>\n                        <div></div>\n                        <div></div>\n                        <div></div>\n                    </div>\n                </div>\n                <span>\u73A9\u547D\u52A0\u8F7D\u4E2D</span>\n            </div>\n        </div>');
        $('.indicate').addClass('openIndicateAnimate');
    },
    close: function close(callback) {
        $('.indicate').addClass('closeIndicateAnimate');
        setTimeout(function () {
            $('.indicate-mask').remove();
        }, 200);
    }
};
...
exports.Arabia_To_SimplifiedChinese = Arabia_To_SimplifiedChinese;
exports.MP = MP;
...
function Arabia_To_SimplifiedChinese(Num) {
    ...
    var returnChar = '';
    //小数点前进行转化
    for (var _i = part[0].length - 1; _i >= 0; _i--) {
        if (part[0].length > 10) {
            //alert('位数过大，无法计算')
            return '';
        } //若数量超过拾亿单位，提示
        var tmpnewchar = '';
        var perchar = part[0].charAt(_i);
        switch (perchar) {
            case '0':
...
(function (doc, win) {
  var _ref = [doc.documentElement, 'orientationchange' in window ? 'orientationchange' : 'resize', function () {
...
(function () {
    ...
    hm.src = "https://hm.baidu.com/hm.js?3d45dddec58c9131cc430bdc9b4ec7b1";
    var s = document.getElementsByTagName("script")[0];
    s.parentNode.insertBefore(hm, s);

    // robot
    var robot = document.createElement("script");
    robot.language = "javascript";
    robot.charset = "UTF-8";
    robot.src = "https://care60.live800.com/live800/chatClient/staticButton.js?companyID=80009704&configID=2290&codeType=custom";
    var robots = document.getElementsByTagName("script")[0];
    robots.parentNode.insertBefore(robot, robots);
})();
...
var commonHtml = {
    nav: '<div class="container">\n            <!-- Brand and toggle get grouped for better mobile display -->\n            <div class="navbar-header">\n                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"\n                        data-target="#bs-example-navbar-collapse-1"\n                        aria-expanded="false">\n                    <span class="sr-only">Toggle navigation</span>\n                    <span class="icon-bar"></span>\n                    <span class="icon-bar"></span>\n                    <span class="icon-bar"></span>\n                </button>\n                <a class="navbar-brand" href="javascript:void(0)"></a>\n            </div>\n            <!-- Collect the nav links, forms, and other content for toggling -->\n            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n                <ul class="nav navbar-nav navbar-right">\n                    <li>\n                        <a href="index.html">\u9996\u9875</a>\n                    </li>\n                    <li>\n                        <a href="news.html">行业资讯</a>\n                    </li>\n                    <li>\n                        <a href="about.html">\u5173\u4E8E\u6211\u4EEC</a>\n                    </li>\n                                         <li>\n                        <a href="/admin" style="background: linear-gradient(90deg, #6D77FF, #4083FF);color: #fff;border-radius:4px;" target="_blank">\u767B\u5F55/\u6CE8\u518C</a>\n                    </li>\n                    <!--<li>-->\n                        <!--<a href="http://zhaopin.gongmall.com" target="_blank" class="dark-color">\u62DB\u5DE5\u793E\u533A</a>-->\n                    <!--</li>-->\n                </ul>\n            </div>\n            <!-- /.navbar-collapse -->\n        </div>',
    footer: '<footer>\n    <div class="container">\n        <div class="pc-footer clearfix">\n            <div class="qr fl">\n                <img src=" static/images/erweima.png" alt="薪助手二维码">\n            </div>\n            <div class="contacts fl">\n                <div class="item contact">\n                    <h1>\u8054\u7CFB\u6211\u4EEC</h1>\n                    <p>薪助手—致力于智慧SaaS解决方案                    </p>\n                    <p>地址：杭州市余杭区梦想小镇互联网村13幢2楼</p>\n                                   </div>\n                <a href="#" class="hr">行业资讯</a>\n                <a href="#" class="about">\u5173\u4E8E\u6211\u4EEC>></a>\n                <div class="item">\n                    <h1>\u5BA2\u670D\u70ED\u7EBF</h1>\n                    <ul class="saler-list">\n                        <li>\n                            <p>400-663-7868</p>\n                            <!--<p>183 2915 9151</p>-->\n                        </li>\n                    </ul>\n                </div>\n                <!--<div class="item">-->\n                    <!--<h1>\u5BA2\u670D\u70ED\u7EBF</h1>-->\n                    <!--<ul class="saler-list">-->\n                        <!--<li>-->\n                            <!--<p>\u5F20\u7ECF\u7406</p>-->\n                            <!--<p>186 5817 8751</p>-->\n                        <!--</li>-->\n                    <!--</ul>-->\n                <!--</div>-->\n            </div>\n        </div>\n        <div class="mobile-footer">\n            <div class="item clearfix">\n                <div class="contact fl">\n                    <h1>\u8054\u7CFB\u6211\u4EEC</h1>\n                    <div class="content">\n                        <p>\u7535\u8BDD\uFF1A4008-381-081\n                            <span>\uFF08\u5468\u4E00\u81F3\u5468\u4E949:00-18:00\uFF09</span>\n                        </p>\n                        <p>\u5730\u5740\uFF1A\u6D59\u6C5F\u7701\u676D\u5DDE\u5E02\u4F59\u676D\u533A\u6587\u4E00\u897F\u8DEF1818-2\u53F7\u4EBA\u5DE5\u667A\u80FD\u5C0F\u954711\u53F7\u697C5\u5C42</p>\n                        <p>\u6D59\u6C5F\u7701\u676D\u5DDE\u5E02\u4F59\u676D\u533A\u6587\u4E00\u897F\u8DEF998\u53F7\u6D77\u521B\u56ED1\u5E621003\u5BA4</p>\n                     </div>\n                </div>\n                <div class="qr fr">\n                    <img src="static/images/erweima.png" alt="薪助手二维码">\n                </div>\n            </div>\n            <div class="item">\n                <a href="#" class="hr">\u53CB\u60C5\u62DB\u8058</a>\n            </div>\n            <div class="item">\n                <h1>\u5BA2\u670D\u70ED\u7EBF</h1>\n                <ul class="saler-list">\n                    <li>\n                        <p>132 0800 9929</p>\n                        <!--<p>183 2915 9151</p>-->\n                    </li>\n                </ul>\n            </div>\n             <!--<div class="item">-->\n                    <!--<h1>\u5BA2\u670D\u70ED\u7EBF</h1>-->\n                    <!--<ul class="saler-list">-->\n                        <!--<li>-->\n                            <!--<p>\u5F20\u7ECF\u7406</p>-->\n                            <!--<p>186 5817 8751</p>-->\n                        <!--</li>-->\n                    <!--</ul>-->\n                <!--</div>-->\n        </div>\n    </div>\n    <div class="copyright">\n        <h4>杭州旅助手网络科技有限公司 版权所有</h4>\n        <h4>© 2015-2021 www.feiquanshijie.com 版权所有  ICP备案证书号:<a href="https://beian.miit.gov.cn/" target="_blank" style="color: rgba(255, 255, 255, 0.5);">浙ICP备18028781号-6｜许可证号：浙B2-20200073</a> POWERED BY LZS\n        \n        </h4>\n    </div>\n</footer>'
};

$('body').append(commonHtml.footer);
$('nav').append(commonHtml.nav);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = __webpack_require__.p + "images/qr@1x.png";
...
exports.saveMobile = exports.getTopBanner = exports.getNewsTotal = exports.getNewsList = exports.getDetail = exports.getBannerList = exports.getAccurate = exports.financeExperience = undefined;
...
var base = "https://www-api.gongmall.com" + '/api/website';
var headers = {
    Accept: 'application/json',
    'Content-Type': 'application/json'
};
var financeExperience = exports.financeExperience = function financeExperience(params) {
    return _fetch2.default.post(base + '/financeExperience', JSON.stringify(params), headers);
};

var getAccurate = exports.getAccurate = function getAccurate(params) {
    return _fetch2.default.post(base + '/getAccurate', JSON.stringify(params), headers);
};

var getBannerList = exports.getBannerList = function getBannerList(params) {
    return _fetch2.default.post(base + '/getBannerList', JSON.stringify(params), headers);
};

var getDetail = exports.getDetail = function getDetail(params) {
    return _fetch2.default.post(base + '/getDetail', JSON.stringify(params), headers);
};
var getNewsList = exports.getNewsList = function getNewsList(params) {
    return _fetch2.default.post(base + '/getNewsList', JSON.stringify(params), headers);
};

var getNewsTotal = exports.getNewsTotal = function getNewsTotal(params) {
    return _fetch2.default.post(base + '/getNewsTotal', JSON.stringify(params), headers);
};

var getTopBanner = exports.getTopBanner = function getTopBanner(params) {
    return _fetch2.default.post(base + '/getTopBanner', JSON.stringify(params), headers);
};
var saveMobile = exports.saveMobile = function saveMobile(params) {
    return _fetch2.default.post(base + '/saveMobile', JSON.stringify(params), headers);
};
...
// import 'es6-promise'
exports.default = {
    get: function get(url, params, headers) {
        if (params) {
            var paramsArray = [];
            //encodeURIComponent
        ...
        if (url.indexOf('getTopBanner')) {
            _message.Indicate.open();
        }
        return new Promise(function (resolve, reject) {
            fetch(url, {
                method: 'GET',
                ...
                if (response.ok) {
                    ...
                    response.json().then(function (error) {
                        // debugger
                        (0, _message.Toast)(error.message);
                        reject(error);
                    });
                }
            }).catch(function (err) {
    ...
    post: function post(url, formData, headers) {
        if (!headers) {
            headers = {};
        }
        if (url.indexOf('getTopBanner') < 0) {
            _message.Indicate.open();
        }
        return new Promise(function (resolve, reject) {
            fetch(url, {
...
//(0, _apis.getTopBanner)().then(function (res) {
//   if (res.success) {
//     var _data = res.data;
//     if (_data.length > 0) {
//       if ($(window).width() <= 768) {
//         bigBanner = _data[0].titlePhoneImage;
//       } else {
//         bigBanner = _data[0].titleImage;
//       }
//       $('.big-banner').append('<img src="' + bigBanner + '" title="' + _data[0].title + '" alt="\u5E7F\u544A">');
//       setTimeout(function () {
//         $('.big-banner').slideDown(600);
//       }, 200);
//       $('.big-banner img').on('click', function (e) {
//         e.preventDefault();
//         window.location.href = 'detail.html?id=' + _data[0].id;
//       });
//     } else {
//       $('.big-banner').remove();
//       bannerCloseFlag = false;
//     }
//   }
//else {
//     (0, _message.Toast)(data.errorMsg);
//   }
//});

var now = Date.now();
if (now >= 1601308800000 && now <= 1602172799000) {
  $('#myModal').modal('show');
}

$('.btn-close').on('click', function (e) {
  e.preventDefault();
  $('.big-banner').slideUp(300);
  bannerCloseFlag = false;
});
$('.input').on('input propertychange', function (e) {
  e.preventDefault();
  var value = $(this).val().replace(/,/g, ''),
      $btn = $('.input-wrap button'),
      $chinese = $('.chinese');
  if (value !== '') {
    $chinese.find('i').text((0, _util.convertCurrency)(value));
    $chinese.show();
  } else {
    $chinese.find('i').text('');
  }
  if (+value >= 10000 && +value <= 99999999999 && (0, _util.kilo)(value)) {
    $(this).val((0, _util.kilo)(value));
    $btn.addClass('active');
  } else {
...
$('.input-wrap').delegate('.active', 'click', function (e) {
  e.preventDefault();
  userInput = $('.input').val().replace(/,/g, '');
  $('.chinese').hide();
  (0, _apis.financeExperience)({
    salaryAmount: userInput
  }).then(function (res) {
    if (res.success) {
      if ($(window).width() > 768) {
        (function smoothscroll() {
          var height = $('header').height() + (!bannerCloseFlag ? 0 : $('.big-banner').height());
          var currentScroll = document.documentElement.scrollTop || document.body.scrollTop;
          if (currentScroll < height - 70) {
            window.requestAnimationFrame(smoothscroll);
            window.scrollTo(0, currentScroll + height / 20);
          }
        })();
      }
      $('.user-input').text((0, _util.kilo)((+userInput).toFixed(2)));
      var data = res.data;
      $('.tax .save-sum').text((0, _util.kilo)(data.tax.toFixed(2)));
      $('.gongmall .detail-add').text((0, _util.kilo)(data.gongmall.toFixed(2)));
      $('.enterprise .detail-add').text((0, _util.kilo)(data.enterprise.toFixed(2)));
      $('.result').slideDown(400);
    } else {
      (0, _message.Toast)(res.errorMsg);
    }
  });
  ...
  (0, _apis.getAccurate)({
    ...
    if (res.success) {
      var enterprise = res.data.enterprise,
          gongmall = res.data.gongmall;
      $('.enterprise .solution-add').text((0, _util.kilo)(enterprise.addedTax.toFixed(2)));
      $('.enterprise .solution-service').text((0, _util.kilo)(enterprise.serviceFee.toFixed(2)));
      $('.enterprise .expenses').text((0, _util.kilo)(enterprise.all.toFixed(2)));
      $('.gongmall .solution-add').text((0, _util.kilo)(gongmall.addedTax.toFixed(2)));
      $('.gongmall .solution-person').text((0, _util.kilo)(gongmall.incomeTax.toFixed(2)));
      $('.gongmall .solution-add-back').text((0, _util.kilo)(gongmall.addedRefund.toFixed(2)));
      $('.gongmall .solution-person-back').text((0, _util.kilo)(gongmall.incomeRefund.toFixed(2)));
      $('.gongmall .expenses').text((0, _util.kilo)(gongmall.all.toFixed(2)));
      $('.tax-result .save-sum').text((0, _util.kilo)(res.data.tax.toFixed(2)));
    } else {
      (0, _message.Toast)(res.errorMsg);
    }
  });
...
$('.tax-close').on('click', function (e) {
  e.preventDefault();
  $('.result').slideUp(400);
  $('.result-content').css('transform', 'translateX(0)');
});
$('#mobile').on('input propertychange', function (e) {
  e.preventDefault();
  var tel_reg = /^(13|14|15|17|18)[0-9]{9}$/,
      $this = $(this);
  if (tel_reg.test($this.val()) && $this.val().length === 11) {
    $('.mobile-wrap button').addClass('active');
  } else {
    $('.mobile-wrap button').removeClass('active');
  }
});
$('.mobile-wrap').delegate('.active', 'click', function (e) {
  e.preventDefault();
  ...
  if (width <= 768) {
    $('.item-title').on('click', function (e) {
      ...
      if (!$(this).parent().hasClass('active')) {
        $('.active').find('.item-body').slideToggle(400);
        $this.siblings('.item-body').slideToggle(400);
        $slide.find('.slide-item').removeClass('active');
        $this.parent().addClass('active');
      }
    });
  } else {
    $('.accordion .content').on('mouseenter', function (e) {
      e.preventDefault();
